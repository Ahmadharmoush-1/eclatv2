...
const Hero = ({ isLowMemoryDevice = false }: HeroProps) => {
  ...
  <Reveal variant="fade-up" delay={100}>
    <h2 className="text-5xl md:text-7xl font-luxury font-bold text-gold mb-2">
      Éclat Parfum
    </h2>
  </Reveal>

  <Reveal variant="fade-up" delay={200}>
    <h3 className="text-5xl md:text-7xl font-luxury font-bold text-gold mb-6">
      BEIRUT
    </h3>
  </Reveal>

  <Reveal variant="fade-up" delay={300}>
    <p className="text-gold-light text-xl md:text-2xl mb-8 font-light tracking-wide">
